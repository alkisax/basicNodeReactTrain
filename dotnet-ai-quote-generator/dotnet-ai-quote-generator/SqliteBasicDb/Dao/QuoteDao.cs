...
public class QuoteDao
{
  ...
  public QuoteDao(AppDbContext db)
  {
    _db = db;
  }

  // create
  public async Task<AiQuoteModel> Create(AiQuoteDto dto, int? userId = null)
  {
    try
    {
  ...
  public async Task<AiQuoteModel?> ReadById(int id)
  {
    try
    {
      ...
      // το άλλαξα για να μπορεί να δείχνει και το ονομα του user
